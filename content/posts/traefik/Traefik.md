...
![](<images/Traefik 解析-image.png>)

查看应用

![](<images/Traefik 解析-image-1.png>)
...
![](<images/Traefik 解析-image-4.png>)

第二种：利用 Traefik 自带的 IngressRoute

![](<images/Traefik 解析-diagram.png>)
...
![](<images/Traefik 解析-diagram-1.png>)
...
![](<images/Traefik 解析-image-6.png>)

直接提示没有 token

带上 jwt 访问

![](<images/Traefik 解析-image-7.png>)
...
![](<images/Traefik 解析-diagram-2.png>)
